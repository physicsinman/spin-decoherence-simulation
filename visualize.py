...
# ============================================================================
# PUBLICATION-QUALITY FIGURE STYLE GUIDE
# ============================================================================
# Unified style for PRB/APS/Nature-quality figures
# Consistent across all plots in the figure set
...
# Fix U+2212 (minus sign) character support issue
# Configure matplotlib to use ASCII minus instead of Unicode minus sign
# This prevents font warnings when fonts don't support U+2212
try:
    import matplotlib.ticker as ticker
    # Use ASCII minus sign instead of Unicode minus (U+2212)
    # This is handled automatically by matplotlib's formatters, but we ensure compatibility
    rcParams['axes.unicode_minus'] = False  # Use ASCII minus instead of U+2212
except:
    pass
...
# ============================================================================
# Consistent color palette across all figures for scientific storytelling
COLOR_SCHEME = {
